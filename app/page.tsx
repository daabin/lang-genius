...
export default async function IndexPage() {
  ...
  return (
    <section>
      <SiteHeader />
      <div className="pt-20 absolute inset-0 z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)]">
